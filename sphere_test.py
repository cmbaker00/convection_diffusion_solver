# https://gitlab.onelab.info/gmsh/gmsh/blob/0bb15586bad052f15d1991ff703d39e01e458986/benchmarks/3d/Sphere.geo

import matplotlib.pyplot as plt
cellSize = 0.05
radius = 1.

from fipy import CellVariable, Gmsh2D, Gmsh3D, TransientTerm, DiffusionTerm, Viewer, TSVViewer
...
X, Y, Z = mesh.faceCenters  # doctest: +GMSH
plt.scatter(X,Y,Z)